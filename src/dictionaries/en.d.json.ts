...
declare const messages: {
  ...
  "Cta": {
    ...
    "emailAddress": "enquires@maxlineglobals.com"
  },
  "Footer": {
  ...
  "CareersPage": {
    ...
    "mission": {
      ...
      "description1": "At Maxline Globals, we don't just offer jobs—we build careers. As a leading provider of cutting-edge technology solutions, logistics innovations, and global distribution, we're on a mission to simplify and transform industries through smart, scalable solutions.",
    ...
    "cta": {
      ...
      "description": "Whether you're an experienced professional or just starting out, Maxline Globals is a place to grow, innovate, and lead. Join us in shaping the future.",
      "applyNow": "Apply Now",
      "emailUs": "Email Us",
