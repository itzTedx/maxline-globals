		...
		>
			<div className="container flex flex-col items-start justify-between pt-24 pb-12 md:pt-40 md:pb-20">
				<div className="space-y-4 md:space-y-6">
					<h1
						className="font-grotesk text-4xl text-brand-dark md:text-5xl lg:text-6xl"
						id="page-title"
						itemProp="name"
					>
						{title}
					...
					<p
						className="font-light text-brand-gray text-lg md:text-xl lg:text-2xl"
				...
				<Button asChild className="mt-8 md:mt-0" size="btnIcon">
					<Link
						...
						className="gap-3 text-brand-dark"
						href={ctaLink}
					>
						{ctaText}
