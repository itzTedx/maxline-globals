...
const MarqueeItem = React.memo(({ children }: { children: React.ReactNode }) => (
  <div className="mx-2.5 cursor-pointer duration-300 ease-in-out hover:scale-105">{children}</div>
));
