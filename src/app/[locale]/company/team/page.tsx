      ...
      >
        ...
        <section className="container">
          ...
          <ul className="grid grid-cols-1 gap-4 pt-12 sm:grid-cols-2 lg:grid-cols-4">
            {TEAMS.map((team, i) => (
              <li className="overflow-hidden rounded-xl bg-brand-dark" key={`${team.nameKey}-${i}`}>
                <div className="relative aspect-5/6">
                  <Image alt="" className="object-cover" fill src={team.image} />
                ...
                <div className="p-2 text-center text-background">
                  <h3 className="font-grotesk text-4xl">{t(team.nameKey as unknown as Parameters<typeof t>[0])}</h3>

                  <p className="font-grotesk text-primary text-xl sm:text-lg">
                    {t(team.designationKey as unknown as Parameters<typeof t>[0])}
                  </p>
                  {team.link && (
                    <Button
