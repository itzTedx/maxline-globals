						...
						<section className="grid gap-10 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.2fr)] lg:items-start">
							<div className="space-y-6 text-muted-foreground text-sm leading-relaxed md:text-base">
								<p>
									...
									operational presence in India. Since its inception in 2013
									(then known as Max Line Inc.), the company has built a
									reputation for reliability, service excellence, and
									customer-focused logistics solutions tailored to the Indian
									market.
								</p>
								<p>
								...
								<p>
									Max Line India is registered under the Ministry of Micro,
									Small &amp; Medium Enterprises (MSME), Government of India,
									with Udyam Registration No.{" "}
									<span className="font-semibold text-foreground">
										Udyam-MH-17-0031335
									</span>
									. This recognition reflects its contribution to India&apos;s
									evolving logistics ecosystem, supporting manufacturers,
									traders, and project owners with compliant and efficient
									freight solutions.
								</p>
								<p>
									...
									connecting domestic trade routes with global shipping
									networks. The team focuses on precise documentation, proactive
									communication, and time-bound execution to meet the
									expectations of customers operating in fast-moving and highly
									regulated sectors.
								</p>
								<p>
