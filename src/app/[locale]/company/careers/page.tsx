    ...
    <main className="relative z-10 rounded-b-3xl bg-background pb-20 shadow-xl">
      ...
      <section className="container py-12 md:py-20">
        <div className="grid gap-8 md:grid-cols-3 md:gap-12">
          <div className="col-span-2 space-y-6">
            ...
            <p className="font-light text-brand-gray text-lg leading-relaxed md:text-xl">{t("mission.description1")}</p>
            <p className="font-light text-brand-gray text-lg leading-relaxed md:text-xl">{t("mission.description2")}</p>
          </div>
          <div className="rounded-2xl bg-muted p-8 md:p-12">
            <div className="space-y-4">
              <h3 className="font-grotesk text-2xl text-brand-dark md:text-3xl">{t("mission.whyChoose.title")}</h3>
          ...
          {benefits.map((benefit: { title: string; description: string }, index: number) => (
            ...
            >
              <div className="flex size-16 items-center justify-center rounded-full bg-muted md:size-20">
                {index === 0 && <IconStar className="size-8 stroke-[1.5] text-brand-gray md:size-12" />}
                {index === 1 && <IconUsers className="size-8 stroke-[1.5] text-brand-gray md:size-12" />}
                {index === 2 && <IconHeart className="size-8 stroke-[1.5] text-brand-gray md:size-12" />}
                {index === 3 && <IconGlobe className="size-8 stroke-[1.5] text-brand-gray md:size-12" />}
                {index === 4 && <IconClock className="size-8 stroke-[1.5] text-brand-gray md:size-12" />}
              </div>
      ...
      <section className="container py-12 md:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mb-8 font-light text-brand-gray text-lg leading-relaxed md:text-xl">{t("cta.description")}</p>
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <Button asChild size="btnIcon">
              <Link className="group gap-3 text-brand-dark" href={`mailto:${t("cta.email")}`}>
                <LetterSwapPingPong
            ...
            <Button asChild className="bg-white" size="btnIcon" variant="secondary">
              <Link className="group gap-3 text-brand-dark" href={`mailto:${t("cta.email")}`}>
                <LetterSwapPingPong
                  className="w-full justify-start font-semibold"
                  label={t("cta.emailUs")}
          ...
          <p className="mt-4 text-brand-gray text-sm">
            {t("cta.resumeText")}{" "}
            <a className="text-secondary hover:underline" href={`mailto:${t("cta.email")}`}>
              {t("cta.email")}
            </a>
          </p>
        </div>
